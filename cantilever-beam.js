    ...
    function varupdate(param) {
        ...
        Wn = Math.sqrt(k / m);
        $('#commentboxleft').html('<b>k</b>=' + (k / 1000).toFixed(2) + ' N/m<br/><b>m</b>=' + m.toFixed(2) + ' kg<br/><b>L</b>=' + L + ' mm');
    ...
    function code() {
        ctx.clearRect(50, 50, 450, 350);
        var _L = (L * 0.1389 + 17.2222);
        var _m = (m * 0.3030 + 19.3939);
        ...
        ctx.moveTo(80, 235);
        ctx.lineWidth = 20;
        ctx.quadraticCurveTo(100 + _L, 235, 160 + _L, 235 + _m * temp * Math.sin(globctr));
        ctx.stroke();
        circle_fill(ctx, _m / 2, 'blue', 160 + _L, 235 + _m * temp * Math.sin(globctr));
        globctr += 0.1;
        if (temp < 0.05) {
            clearInterval(intT);
        }
    ...
    function add_support(canvas, x, y) {
