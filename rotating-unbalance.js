 var f0, m, _dR, k;
    ...
    window.onload = function() {
        ...
        $('#fFreqspinner').spinner('value', 100);
        varupdate(true);
        $('#simplots').hide();
        ctx.moveTo(0, 100);
        ctx.lineTo(250, 100);
    ...
    function varupdate(plot) {
        ...
        $('#commentboxright').html("<b>ω<sub>n</sub></b>=" + Wn.toFixed(2) + "<br /><b>ω</b>=" + W.toFixed(2));
        if (Math.abs(Wn - W) < 2)
    ...
    function graphPlot() {
        ...
        YofT.beginPath();
        var _ampFactor=Math.min(ampFactor,2);
        YofT.moveTo(0, 300 + (5 + 15 * f0 / 10) * _ampFactor * Math.sin((W * 0.1 * (-0.01)) + phi));
        for (t_g = 0; t_g <= 12 + W / 20; t_g += 0.01) {
            YofT.lineTo((t_g * (20 - W / 5)), 300 + (5 + 15 * f0 / 10) * _ampFactor * Math.sin((W * 0.1 * (t_g)) + phi));
        }
        ...
        YofT.beginPath();
        if (5 + 15 * f0 / 10 < 60) {
            YofT.moveTo(0, 100 + (5 + 15 * f0 / 10) * Math.sin((W * 0.1 * (-0.01))));
        } else {
            YofT.moveTo(0, 100 + 60 * Math.sin((W * 0.1 * (-0.01))));
        }
        for (t_g = 0; t_g <= 12 + W / 20; t_g += 0.01) {
            if (5 + 15 * f0 / 10 < 60) {
                YofT.lineTo((t_g * (20 - W / 5)), 100 + (5 + 15 * f0 / 10) * Math.sin((W * 0.1 * (t_g))));
            } else {
                YofT.lineTo((t_g * (20 - W / 5)), 100 + 60 * Math.sin((W * 0.1 * (t_g))));
            }
        }
    ...
    function code() {
        var _ampFactor=Math.min(ampFactor,1.2);
        ctx.clearRect(250, 0, 550, 400);
        draw_mass(ctx, 275, 150 + (5 + 15 * f0 / 10) * _ampFactor * Math.sin((10 * t) + phi), 150, 20 + 50 * ((m - 2) / 198));
        draw_spring(ctx, 300, 150 + (5 + 15 * f0 / 10) * _ampFactor * Math.sin((10 * t) + phi), 300, 300, 5, 20);
        draw_damper(ctx, 400, 150 + (5 + 15 * f0 / 10) * _ampFactor * Math.sin((10 * t) + phi), 400, 300, 150, 50);
    ...
    function draw_mass(c_var, bottom_x, bottom_y, _width, _height) {
        ...
        circle_fill(c_var, 0.35 * _height, 'white', bottom_x + _width / 2, bottom_y - _height / 2);
        circle_fill(c_var, 0.1 * _height, 'black', bottom_x + _width / 2 + 0.25 * _height * Math.cos(10 * t), bottom_y - _height / 2 + 0.25 * _height * Math.sin(10 * t));
    }
